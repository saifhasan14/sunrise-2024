...
//                 <Button icon={<CloseOutlined />} onClick={deleteTask} style={{ backgroundColor: "red", color: "white" }}>
//                   Delete
//                 </Button>
//               </Tooltip>
//               <Tooltip title="Edit Task">
//                 <Button icon={<EditOutlined />} onClick={updateClick} style={{ backgroundColor: "orange", color: "white" }}>
//                   Update
//                 </Button>
//               </Tooltip>
//             </div>
